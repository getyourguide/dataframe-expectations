...
def test_expectation_name():
    ...
    assert expectation.get_expectation_name() == "ExpectationValueNotNull", f"Expected 'ExpectationValueNotNull' but got: {expectation.get_expectation_name()}"
...
def test_suite_pandas_success():
    expectations_suite = DataframeExpectationsSuite().expect_value_not_null(
        column_name="col1"
    )
    data_frame = pd.DataFrame({"col1": [1, 2, 3]})
