...
def test_expectation_name():
    ...
    assert expectation.get_expectation_name() == "ExpectationStringLengthBetween", f"Expected 'ExpectationStringLengthBetween' but got: {expectation.get_expectation_name()}"
...
def test_expectation_pyspark_violations(spark):
    ...
    data_frame = spark.createDataFrame(
        [("fo",), ("bazz",), ("hellothere",), ("foobar",)], ["col1"]
    )
    result = expectation.validate(data_frame=data_frame)
