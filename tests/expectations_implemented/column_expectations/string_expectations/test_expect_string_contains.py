...
def test_expectation_name():
    ...
    assert expectation.get_expectation_name() == "ExpectationStringContains", f"Expected 'ExpectationStringContains' but got: {expectation.get_expectation_name()}"
